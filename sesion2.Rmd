...
- < 0.15 : indica que la moda no es significativa, puede haber multimodalidad.
- entre 0.15 - 0.25: hay una moda.
- > 0.25: hay una moda y los demás valores están lejos de 'hacerle pelea'.
...
Sabiendo que hay poca comptencia, podemos calcular el indice de Laakso - Taagepera:
