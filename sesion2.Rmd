...
* Simetria. Como tenemos la mediana, tiene sentido saber si los valores menores o mayores a estos se distribuyen de manera simetrica (acampanados). Si el coeficiente de asimetría :
```{r}
